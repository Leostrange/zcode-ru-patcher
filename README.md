<div align="center">
  ...
  <p>
    <a href="https://github.com/Leostrange/zcode-ru-patcher/releases/tag/v6.3">
      <img alt="Release" src="https://img.shields.io/badge/release-v6.3-2563eb?style=for-the-badge">
    </a>
  ...
  <p>
    <a href="https://github.com/Leostrange/zcode-ru-patcher/releases/tag/v6.3"><b>Скачать патч</b></a>
    ·
...
3. Скачайте патч из [Releases](https://github.com/Leostrange/zcode-ru-patcher/releases/tag/v6.3), запустите его и пропатчите ZCode.
...
- Переведены описания и названия скиллов/инструментов.
- Исправлены оставшиеся непереведённые UI-строки.
- Патчер пересобран на NSIS без MUI в silent self-extractor.
- Исправлена ошибка `Error opening file for writing` при распаковке патча.
...
```text
ZCode-Ru-Patcher-v6.3.exe
```

SHA256:

```text
AA83850B7692A16CF79378831EE6C461202782A98839FE2E31027F5B8A046B20
```

Ссылка: https://github.com/Leostrange/zcode-ru-patcher/releases/tag/v6.3
