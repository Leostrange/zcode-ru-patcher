<div align="center">
  ...
  <p>
    <a href="https://github.com/Leostrange/zcode-ru-patcher/releases/tag/v6.3.1">
      <img alt="Release" src="https://img.shields.io/badge/release-v6.3.1-2563eb?style=for-the-badge">
    </a>
  ...
  <p>
    <a href="https://github.com/Leostrange/zcode-ru-patcher/releases/tag/v6.3.1"><b>Скачать патч</b></a>
    ·
...
3. Скачайте патч из [Releases](https://github.com/Leostrange/zcode-ru-patcher/releases/tag/v6.3.1), запустите его и пропатчите ZCode.
...
- Добавлены переводы дополнительных состояний отката: `нет checkpoint`, `нет файлов для восстановления`, `сессия занята`, `целевое сообщение не найдено`.
...
Ссылка: https://github.com/Leostrange/zcode-ru-patcher/releases/tag/v6.3.1
