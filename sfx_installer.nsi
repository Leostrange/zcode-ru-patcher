...
OutFile "ZCode-Ru-Patcher-v6.3.8.exe"
...
VIProductVersion "6.3.8.0"
VIAddVersionKey "ProductName" "${PRODUCT_NAME}"
VIAddVersionKey "ProductVersion" "${PRODUCT_VERSION}"
VIAddVersionKey "FileDescription" "Русификатор ZCode"
VIAddVersionKey "FileVersion" "6.3.8.0"
VIAddVersionKey "OriginalFilename" "ZCode-Ru-Patcher-v6.3.8.exe"
